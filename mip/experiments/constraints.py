...
_tgd_different_variables = _tgd_committee_members_list_end
GLASGOW_DATASET_TGD_FOR_EACH_DISTRICT_AT_LEAST_ONE_REPRESENTATION = (_tgd_dict_start, _tgd_committee_members_list_start,
                                                                     _tgd_dict_end, _tgd_committee_members_list_end,
                                                                     _tgd_candidates_tables_start,
                                                                     _tgd_candidates_tables_end,
                                                                     _tgd_different_variables)
...
_tgd_candidates_tables_end = ['t2']
_tgd_different_variables = _tgd_committee_members_list_end
GLASGOW_DATASET_TGD_FOR_EACH_IMPORTANT_PARTY_AT_LEAST_ONE_REPRESENTATION = (_tgd_dict_start,
                                                                            _tgd_committee_members_list_start,
                                                                            _tgd_dict_end,
                                                                            _tgd_committee_members_list_end,
                                                                            _tgd_candidates_tables_start,
                                                                            _tgd_candidates_tables_end,
                                                                            _tgd_different_variables)
...
_tgd_different_variables = _tgd_committee_members_list_end
GLASGOW_DATASET_TGD_FOR_EACH_DISTRICT_AT_LEAST_THREE_REPRESENTATION = (_tgd_dict_start,
                                                                       _tgd_committee_members_list_start, _tgd_dict_end,
                                                                       _tgd_committee_members_list_end,
                                                                       _tgd_candidates_tables_start,
                                                                       _tgd_candidates_tables_end,
                                                                       _tgd_different_variables)
...
MOVIES_DATASET_TGD_FOR_EACH_IMPORTANT_ORIGINAL_LANGUAGE_AT_LEAST_ONE_REPRESENTATION = \
    (_tgd_dict_start, _tgd_committee_members_list_start, _tgd_dict_end, _tgd_committee_members_list_end,
     _tgd_candidates_tables_start, _tgd_candidates_tables_end, _tgd_different_variables)
...
_tgd_candidates_tables_end = ['t2']
_tgd_different_variables = _tgd_committee_members_list_end
MOVIES_DATASET_TGD_FOR_EACH_RUNTIME_LENGTH_AT_LEAST_ONE_REPRESENTATION = (_tgd_dict_start,
                                                                          _tgd_committee_members_list_start,
                                                                          _tgd_dict_end,
                                                                          _tgd_committee_members_list_end,
                                                                          _tgd_candidates_tables_start,
...
_tgd_candidates_tables_end = ['t2']
_tgd_different_variables = _tgd_committee_members_list_end
MOVIES_DATASET_TGD_FOR_EACH_IMPORTANT_GENRE_AT_LEAST_ONE_REPRESENTATION = (_tgd_dict_start,
                                                                           _tgd_committee_members_list_start,
                                                                           _tgd_dict_end,
                                                                           _tgd_committee_members_list_end,
                                                                           _tgd_candidates_tables_start,
