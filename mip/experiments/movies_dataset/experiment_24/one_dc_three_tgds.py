...
_experiment_number = 24
MODULE_NAME = f'Movies Experiment {_experiment_number}:'

if __name__ == '__main__':
    # ---------------------------------------------------------------------------
    # Experiment summary:
    # We find a winning committee with two DC and two TGDs.
    # DC: There are no three committee members (i.e. movies) with the same genre.
    # TGD_1: There is a committee member for every original language from the important languages table.
    # TGD_2: There is a committee member for every runtime length.
    # TGD_3: There is a committee member for every genre in important genres table.
    # ---------------------------------------------------------------------------
    ...
    # TGD 3:
    _tgd_dict_start3 = dict()
    _tgd_dict_start3['important_genres', 't1'] = [('x', 'genre')]
    _committee_members_list_start3 = []
    _candidates_tables_start3 = []

    _tgd_dict_end3 = dict()
    _tgd_dict_end3['movies_genres', 't2'] = [('c1', config.CANDIDATES_COLUMN_NAME),
                                             ('x', 'genre')]
    _committee_members_list_end3 = ['c1']
    _candidates_tables_end3 = ['t2']

    _different_variables3 = _committee_members_list_end3

    _tgds.append(
        (_tgd_dict_start3, _committee_members_list_start3, _tgd_dict_end3,
         _committee_members_list_end3, _candidates_tables_start3, _candidates_tables_end3, _different_variables3))
