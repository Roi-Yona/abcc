...
if __name__ == '__main__':
    ...
    _tgds = [constraints.MOVIES_DATASET_TGD_FOR_EACH_IMPORTANT_ORIGINAL_LANGUAGE_AT_LEAST_ONE_REPRESENTATION,
             constraints.MOVIES_DATASET_TGD_FOR_EACH_RUNTIME_LENGTH_AT_LEAST_ONE_REPRESENTATION,
             constraints.MOVIES_DATASET_TGD_FOR_EACH_IMPORTANT_GENRE_AT_LEAST_ONE_REPRESENTATION]
